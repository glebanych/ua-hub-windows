...
using UAHub.Services;

#if WINDOWS_APP
using Windows.System;
using Windows.UI.Core;
using Windows.UI.ApplicationSettings;
using UAHub.AppFlyouts;
#endif
...
namespace UAHub
{
    ...
    {
        private Guid APP_ID = new Guid("7b2f7632-3f2c-4204-b524-a896915b4cff");
        public const string APP_NAME = "UA Hub";
        ...
        private void UpdateAppTiles()
        {
            ...
            {
                TileServices.CreateFlipTile(@";)", @"А твої очі променіють,як сонце");
