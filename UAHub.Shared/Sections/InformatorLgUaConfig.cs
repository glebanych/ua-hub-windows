...
{
    public class InformatorLgUaConfig : SectionConfigBase<TwitterDataConfig, TwitterSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("InformatorLgUaListPage");
            }
        }
