...
{
    public class LuganskNewsTodayConfig : SectionConfigBase<TwitterDataConfig, TwitterSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("LuganskNewsTodayListPage");
            }
        }
