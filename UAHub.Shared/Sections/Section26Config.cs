...
{
    public class Section26Config : SectionConfigBase<LocalStorageDataConfig, HtmlSchema>
    {
        ...
        public override LocalStorageDataConfig Config
        {
            get
            {
                ...
                {
                    FilePath = "/Assets/Data/Section26.htm"
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("Section26ListPage");
            }
        }
